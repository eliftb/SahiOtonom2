...
class DepthImageSubscriber(Node):
    ...
    def yolo_callback(self, data):
        ...
        if not data.yolov8_inference:
            ...
            for result in data.yolov8_inference:
                ...
                self.detections.append((class_name, center_x, center_y, self.left, self.top, self.right, self.bottom, self.confidence))
    ...
    def camera_callback(self, data):
        ...
        if self.detections:
            for detection in self.detections:
                class_name, center_x, center_y, left, top, right, bottom , confidence = detection
    ...
    def depth_image_callback(self, data):
        ...
        for class_name, center_x, center_y, left, top, right, bottom, confidence in self.detections:
            ...
            if isinstance(depth_value, (np.float32, np.float64, float, int)):
                ...
                depth_msg.confidence = confidence
                self.depth_pub.publish(depth_msg)
